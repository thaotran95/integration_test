...
${TOOLCHAIN_armhf}/arm-linux-gnueabihf-g++ -o linux_imx6_armhf --sysroot=/opt/sdk/renesas-targetfs -DLINUX -DEGL_API_FB -I /opt/sdk/gcc-linaro-4.9.4-2017.01-x86_64_arm-linux-gnueabihf/arm-linux-gnueabihf/include/ -L /opt/sdk/gcc-linaro-4.9.4-2017.01-x86_64_arm-linux-gnueabihf/arm-linux-gnueabihf/lib -L /opt/sdk/renesas-targetfs/lib test.cpp -lGLESv2 -lEGL -lGAL -lm -ldl -Wall
